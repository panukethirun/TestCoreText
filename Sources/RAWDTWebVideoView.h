...
@class RAWDTWebVideoView;
@class DTTextAttachment;

/**
 Protocol for delegates of <DTWebVideoView>
*/
@protocol RAWDTWebVideoViewDelegate <NSObject>
...
- (BOOL)videoView:(RAWDTWebVideoView *)videoView shouldOpenExternalURL:(NSURL *)url;
